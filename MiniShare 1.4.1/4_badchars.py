# Finding the bad characters, we can do some cross check on the missing characters
# Using mona.py to compare the bytearray or might used another different method
# Bad characters found are: 0x00 and 0x0D
